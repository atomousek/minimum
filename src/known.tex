...
\subsection{Clustering over WhyTe}
...
Tim jsme ziskali nejake parametry, ale jeden z nich nikoli, takze jsme to museli normalizovat, aby bylo mozne posoudit, zda je ten model korektni... mno, budu to muset nejak promyslet.
